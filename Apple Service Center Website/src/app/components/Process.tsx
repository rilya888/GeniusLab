...
const steps = [
  {
    ...
    number: "01",
    title: "Diagnostica",
    description: "I nostri esperti esaminano il dispositivo e forniscono una valutazione dettagliata"
  },
  {
    icon: Wrench,
    number: "02",
    title: "Riparazione",
    description: "Riparazione professionale con ricambi originali Apple e garanzia"
  },
  {
    icon: CheckCircle,
    number: "03",
    title: "Controllo Qualità",
    description: "Test approfonditi per garantire che tutto funzioni perfettamente"
  }
];
  ...
  return (
    <section className="min-h-screen bg-white px-6 py-24">
      <div className="max-w-7xl mx-auto">
        ...
        >
          Semplice, trasparente ed efficiente
        </motion.p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {steps.map((step, index) => (
            ...
            >
              ...
              <h3 className="text-2xl font-light mb-3 text-black">{step.title}</h3>
